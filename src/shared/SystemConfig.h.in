...
#ifndef _PACKAGENAME
#define _PACKAGENAME "AndeeriaCore"
#endif
...
# define _VERSION(REVN, REVM) "0.2" " ( A:" REVN " M:" REVM " )"
#else
# define _VERSION(REVN, REVM) "0.2" " ( A:" REVN " M:" REVM " )"
#endif
#endif
...
#define _FULLVERSION(REVN, REVM) _PACKAGENAME "/" _VERSION(REVN, REVM) " for " _ENDIAN_PLATFORM
