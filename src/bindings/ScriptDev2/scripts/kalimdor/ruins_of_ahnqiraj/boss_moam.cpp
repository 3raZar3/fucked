        ...
        switch(Phase)
        {
            case PHASE_ATTACKING:
                if (m_uiCheckoutMana_Timer <= uiDiff)
                {
                    ...
                    {
                        DoCastSpellIfCan(m_creature, SPELL_ENERIZE);
                        DoScriptText(EMOTE_ENERGIZING, m_creature);
                        Phase = PHASE_ENERGIZING;
                        return;
                    }
                } else m_uiCheckoutMana_Timer -= uiDiff;
                ...
                if (m_uiSummonManaFiends_Timer <= uiDiff)
                {
                    ...
                    m_uiSummonManaFiends_Timer = 90000;
                } else m_uiSummonManaFiends_Timer -= uiDiff;
            ...
            case PHASE_ENERGIZING:
                if (m_uiCheckoutMana_Timer <= uiDiff)
                {
                    ...
                    {
                        m_creature->RemoveAurasDueToSpell(SPELL_ENERIZE);
